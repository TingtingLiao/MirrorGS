...
from utils.render_utils import save_img_f32, save_img_u8, save_mask_u8
...
class GaussianExtractor(object):
    def __init__(self, gaussians, render, pipe, bg_color=None):
        ...
        self.mirror_transform = gaussians.compute_mirror_plane(min_opacity=0.7)
    ...
    def reconstruction(self, viewpoint_stack):
        ...
        for i, viewpoint_cam in tqdm(enumerate(self.viewpoint_stack), desc="reconstruct radiance fields"):
            ...
            mirror_image = self.render(viewpoint_cam, self.gaussians, mirror_transform=self.mirror_transform)["render"]  
            rgb = rgb * (1 - mirror_mask) + mirror_image * mirror_mask
