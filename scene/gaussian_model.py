...
class GaussianModel:
    ...
    def save_ply(self, path):
        ...
        attributes = np.concatenate((xyz, normals, f_dc, f_rest, opacities, mirror_opacities, scale, rotation), axis=1)
    ...
    def load_ply(self, path):
        ...
        mirror_opacities = np.asarray(plydata.elements[0]["mirror_opacity"])[..., np.newaxis]
        ...
        self._mirror_opacity = nn.Parameter(torch.tensor(mirror_opacities, dtype=torch.float, device="cuda").requires_grad_(True)) 
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_opacities, new_mirror_opacities, new_scaling, new_rotation):
        d = {"xyz": new_xyz,
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacity, new_mirror_opacity, new_scaling, new_rotation)
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacities, new_mirror_opacity, new_scaling, new_rotation)
